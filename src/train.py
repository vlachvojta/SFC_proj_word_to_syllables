...
def train(net, train_data: Dataset, val_data: Dataset, charset: Charset, learn_rate, hidden_dim=8, epochs=5, device='cpu',
...
def main():
    ...
    _ = train(GRUNetBinaryEmbeding, trn_dataset, val_dataset, charset, learn_rate=0.0001, hidden_dim=256, device=device,
              batch_size=250, epochs=5, save_step=5, view_step=1,
              training_path='models/042_gru_binary_emb_256h_29000data_TEST')
